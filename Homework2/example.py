...
from model import MODELRESH, MODELRESW, YourModel
import numpy as np
...
def train(model: nn.Module,
    ...
    for epoch_idx in range(num_epochs):
        ...
        tqdm_train_loader = tqdm(train_loader)  #添加进度条
...
if __name__ == '__main__':
    ...
    # dynamic quantize
    if quantizeType=="dynamic": #动态量化
        DynamicQuantize(net)
    elif quantizeType=="ptq":   #静态量化

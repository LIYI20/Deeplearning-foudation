...
class YourModel(nn.Module):
    def __init__(self, num_classes) -> None:
        ...
        self.layers.append(nn.Conv2d(3,32,3,padding=1))
        self.layers.append(nn.BatchNorm2d(32))
        self.layers.append(nn.ReLU(inplace=True))
        ...
        # self.layers.append(nn.ReLU(inplace=True))
        # # [N, 64, 8, 8]
        # self.layers.append(nn.Conv2d(64, 128, 3, stride=2, padding=1))
        # self.layers.append(nn.BatchNorm2d(128))
        # self.layers.append(nn.ReLU(inplace=True))
        # # [N, 64, 4, 4]
        # self.layers.append(nn.Conv2d(128, 256,3, stride=2, padding=1))
        # self.layers.append(nn.BatchNorm2d(256))
        # self.layers.append(nn.ReLU(inplace=True))
        # # [N, 128, 2, 2]
        # self.layers.append(nn.Conv2d(256, 1024, 3, stride=2, padding=1))
        # self.layers.append(nn.ReLU(inplace=True))
        # self.layers.append(nn.Flatten())
        # # [N, 256]
        # self.layers.append(nn.Linear(1024, num_classes))
        ...
        # self.layers = nn.ModuleList(self.layers)
        #[N,32,8,8]
        self.layers.append(nn.Conv2d(32,64,3,padding=1))  
        self.layers.append(nn.BatchNorm2d(64))    
        self.layers.append(nn.ReLU(inplace=True))
        self.layers.append(nn.MaxPool2d(2))
        #[N,64,4,4]
        self.layers.append(nn.Conv2d(64,128,3,padding=1))
        self.layers.append(nn.BatchNorm2d(128))
        self.layers.append(nn.ReLU(inplace=True))
        self.layers.append(nn.MaxPool2d(2))
        #[N,128,2,2]
            ...
            if isinstance(self.layers[idx],nn.Conv2d):
                if idx+1<len(self.layers) \
                    ...
                    if idx+2<len(self.layers) \
                        ...
                        fuse_modules(self.layers, [str(idx), str(idx+1), str(idx+2)], inplace=True)
                    else:
                        fuse_modules(self.layers, [str(idx), str(idx+1)], inplace=True)